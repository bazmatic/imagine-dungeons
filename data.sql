-- data.sql for The Burning District Adventure
-- This script populates the database with sample data for the AI-powered text adventure game
-- "The Burning District" - a fantasy world where magical flames consume an area
-- 
-- NOTE: Run schema.sql first to create the database structure

-- =============================================================================
-- SAMPLE DATA FOR "THE BURNING DISTRICT" ADVENTURE
-- =============================================================================

-- LOCATION DATA
-- Defines all the locations in the Burning District scenario
...
-- AGENT DATA
-- Defines all the characters in the Burning District scenario
-- Includes both player characters and AI-controlled NPCs with their personalities and stats
...
-- Set Paff as non-autonomous (player character)
UPDATE agent SET autonomous = FALSE WHERE agent_id = 'char_39322';

-- ITEM DATA
-- Defines all the objects, weapons, tools, and treasures in the Burning District
-- Items can be carried by agents, found in locations, or hidden for discovery
...
-- EXIT DATA
-- Defines all the connections between locations in the Burning District
-- Creates the navigation map that allows agents to move between areas
...
-- =============================================================================
-- DYNAMIC CREATURE SPAWNING SYSTEM
-- =============================================================================

-- CREATURE TEMPLATE DATA
-- Defines templates for creatures that can be spawned dynamically in locations
-- These templates are used to create enemies and NPCs based on location and events
...
-- CREATURE SPAWN DATA
-- Defines which creatures can spawn in which locations and their spawn probabilities
-- Higher spawn_chance values mean creatures are more likely to appear in that location
