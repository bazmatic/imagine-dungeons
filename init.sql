...
INSERT INTO exit (exit_id, name, short_description, long_description, owner_location_id, direction, destination_id, locked, notes) VALUES
    ...
    ('exit_to_markets', 'Tavern Back Door', 'A door leading to the dockside markets', 'A sturdy door at the back of the tavern, leading out to the bustling dockside markets.', 'loc_flaming_goblet', 'south', 'loc_dockside_markets', TRUE, 'Locked from the inside. Captain Serena will open it for you if you ask her.'),
