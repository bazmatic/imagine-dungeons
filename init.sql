...
INSERT INTO agent (agent_id, name, short_description, long_description, owner_location_id, capacity, backstory, mood, current_intent, goal) VALUES
    ...
    ('char_47802', 'Pyra', 'A mysterious pyromancer', 'A tall woman with fiery red hair and eyes that seem to flicker with inner flame.', 'loc_elemental_plaza', 25, 'A powerful pyromancer who seeks to understand and possibly control the magical fires of the district.', 'Intense', 'Study the behavior of magical flames', 'Harness the power of the Burning District'),
    ...
    ('char_59731', 'Inferna', 'The fire elemental matriarch', 'A massive, majestic fire elemental with a form that vaguely resembles a female humanoid.', 'loc_elemental_plaza', 100, 'The mother of the trapped fire elementals, she guards the district and seeks to free her children.', 'Protective', 'Guard the Phoenix Heart', 'Free her children from the Phoenix Heart'),
    ...
    ('char_75024', 'Cinder Golem', 'A lumbering ash construct', 'A large, humanoid figure made of compressed ash and burning embers.', 'loc_smoldering_square', 80, 'Created by Cinder to assist with heavy lifting and protection during salvage operations.', 'Stoic', 'Follow Cinder''s commands', 'Protect the fire salvagers'),
