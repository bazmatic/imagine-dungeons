...
INSERT INTO agent (agent_id, name, short_description, long_description, owner_location_id, capacity, backstory, mood, current_intent, goal, health, damage, autonomous) VALUES
    ('char_39322', 'Paff Pinkerton', 'A determined young adventurer', 'Paff is a youth with a fierce determination in his eyes, seeking to uncover the truth about the Burning District.', 'loc_flaming_goblet', 30, 'Nephew of the wizard Bob, Paff believes his uncle was involved in creating the Burning District and seeks to stop the eternal fire.', 'Determined', 'Find adventurers to help explore the district', 'Discover the truth about the Phoenix Heart', 20, 2, TRUE),
    ('char_84751', 'Captain Serena', 'A seasoned sea captain', 'Captain Serena is a tall tiefling with red skin and sharp horns, wearing a coat of fish scales.', 'loc_flaming_goblet', 40, 'A veteran sailor whose ship is undergoing repairs. She has valuable information about Zezran and the elemental plane of water.', 'Cautious', 'Oversee ship repairs', 'Return to the sea', 25, 3, TRUE),
    ('char_62103', 'Uncle Bob', 'A cranky old wizard', 'Bob is a cantankerous old man in a singed wizard''s robe, hiding a guilty secret.', 'loc_burning_street', 20, 'Former colleague of Zezran, Bob was involved in the creation of the Phoenix Heart and the subsequent burning of the district.', 'Anxious', 'Prevent others from discovering his secret', 'Obtain the Phoenix Heart for himself', 18, 4, TRUE),
    ('char_15987', 'Elysia Everwood', 'A distressed elven woman', 'Elysia is an elf with a haunted look in her eyes, her clothes singed and tattered.', 'loc_fire_salvagers', 25, 'Last of a renowned elven family, Elysia seeks to clear her name and uncover the truth behind a magical catastrophe.', 'Desperate', 'Escape from bandits', 'Redeem herself and restore her family''s honor', 22, 2, TRUE),
    ...
    ('char_28934', 'Ashen', 'A somber ash elemental', 'A humanoid figure made of tightly packed ash, with glowing embers for eyes.', 'loc_ash_lane', 50, 'Formed from the ashes of the district, Ashen mourns the loss of the old city and seeks to preserve its memories.', 'Melancholy', 'Collect remnants of the old city', 'Preserve the history of the district', 35, 4, TRUE),
    ('char_53679', 'Flicker', 'A nervous flame dancer', 'A lithe human with hair that constantly shifts between various shades of red and orange.', 'loc_phoenix_row', 15, 'A performer who developed unique fire manipulation abilities after the district''s transformation.', 'Anxious', 'Perfect fire dancing techniques', 'Find a way to control the district''s flames', 20, 2, TRUE),
    ('char_91245', 'Cinder', 'A gruff fire salvager', 'A stocky dwarf with soot-stained skin and a beard that occasionally smolders.', 'loc_smoldering_square', 40, 'Once a smith, now Cinder leads a group of salvagers who brave the flames to recover valuable items.', 'Determined', 'Organize salvaging expeditions', 'Rebuild a new community from the ashes', 28, 3, TRUE),
    ('char_47802', 'Pyra', 'A mysterious pyromancer', 'A tall woman with fiery red hair and eyes that seem to flicker with inner flame.', 'loc_elemental_plaza', 25, 'A powerful pyromancer who seeks to understand and possibly control the magical fires of the district.', 'Intense', 'Study the behavior of magical flames', 'Harness the power of the Burning District', 24, 4, TRUE),
    ('char_36510', 'Smolder', 'A cynical ex-firefighter', 'A muscular human with burn scars covering half his face, wearing tattered firefighter gear.', 'loc_burning_street', 35, 'Once dedicated to fighting fires, Smolder now believes the district is beyond saving and warns others to leave.', 'Pessimistic', 'Discourage newcomers from staying', 'Find a way to escape the Burning District', 26, 3, TRUE),
    ('char_82367', 'Ash Pup', 'A playful ash dog', 'A small dog-like creature made of ash and embers, leaving a trail of soot wherever it goes.', 'loc_ash_lane', 10, 'Born from the ashes of the district, this creature has become Ashen''s loyal companion.', 'Curious', 'Explore and play in the ash', 'Find interesting objects buried in the ash', 12, 1, TRUE),
    ('char_59731', 'Inferna', 'The fire elemental matriarch', 'A massive, majestic fire elemental with a form that vaguely resembles a female humanoid.', 'loc_elemental_plaza', 100, 'The mother of the trapped fire elementals, she guards the district and seeks to free her children.', 'Protective', 'Guard the Phoenix Heart', 'Free her children from the Phoenix Heart', 60, 6, TRUE),
    ('char_13498', 'Spark', 'An energetic messenger', 'A young halfling with hair that stands on end, crackling with static electricity.', 'loc_flaming_goblet', 15, 'A swift runner who delivers messages and small packages throughout the Burning District.', 'Energetic', 'Deliver messages quickly', 'Map out all the safe routes in the district', 18, 2, TRUE),
    ('char_75024', 'Cinder Golem', 'A lumbering ash construct', 'A large, humanoid figure made of compressed ash and burning embers.', 'loc_smoldering_square', 80, 'Created by Cinder to assist with heavy lifting and protection during salvage operations.', 'Stoic', 'Follow Cinder''s commands', 'Protect the fire salvagers', 45, 5, TRUE),
    ('char_20876', 'Flamebeak', 'A fiery phoenix', 'A magnificent bird with feathers of dancing flames and eyes like glowing coals.', 'loc_phoenix_row', 20, 'A magical creature that has made its home in the Burning District, symbolizing hope and renewal.', 'Majestic', 'Soar above the burning streets', 'Inspire hope in the district''s inhabitants', 30, 3, TRUE),
    ('char_fs001', 'Fire Slater Alpha', 'A fiery, insect-like creature', 'A small, isopod-like creature with a glowing red carapace that radiates heat.', 'loc_burning_street', 5, 'Native to the Elemental Plane of Fire, now inhabiting the Burning District.', 'Neutral', 'Scavenge for food', 'Survive in the Burning District', 10, 2, TRUE),
    ('char_fs002', 'Fire Slater Beta', 'A heat-emitting elemental bug', 'An agile, fiery creature that can squeeze through narrow spaces.', 'loc_ash_lane', 5, 'Adapted to extreme temperatures, thriving in the ashes of the district.', 'Cautious', 'Explore ash piles', 'Find suitable nesting area', 10, 2, TRUE),
    ('char_fs003', 'Fire Slater Gamma', 'A swift, flame-colored isopod', 'A small elemental creature with sharp mandibles and a defensive heat burst ability.', 'loc_ember_avenue', 5, 'Scuttled through a planar rift during the district''s transformation.', 'Defensive', 'Guard territory', 'Establish a colony', 10, 2, TRUE),
    ('char_fs004', 'Fire Slater Delta', 'A nimble fire elemental bug', 'An insect-like being of living flame, capable of releasing bursts of heat.', 'loc_inferno_alley', 5, 'Drawn to the intense heat of Inferno Alley.', 'Aggressive', 'Patrol for intruders', 'Protect fire elemental interests', 10, 2, TRUE),
    ('char_fs005', 'Fire Slater Epsilon', 'A heat-radiating elemental creature', 'A small, fiery isopod with the ability to move through extremely tight spaces.', 'loc_smoldering_square', 5, 'Thrives in the smoldering ruins, feeding on charred debris.', 'Curious', 'Investigate new scents', 'Expand territory', 10, 2, TRUE);
